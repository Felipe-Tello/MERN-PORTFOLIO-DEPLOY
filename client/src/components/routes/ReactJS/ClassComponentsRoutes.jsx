...
const ClassComponentsRoutes = () => {
    return ( 
        <div>
            <Routes>
                <Route path="/" element={<ClassComponentsIndex />}/>
                <Route path="/apoyalo" element={
                    <div>
                        <div className="Title">
                            <h2>Apóyalo <a target="_blank" rel="noreferrer" href="https://github.com/Felipe-Tello/Coding-Dojo-MERN/tree/main/2-%20ReactJS/2-%20Class%20components/1-%20Prop%20it%20up/client"><img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" width={50} height={50} alt="GitHub logo"/></a></h2>
                ...
                <Route path="/poniendo-todo-junto" element={
                    <div>
                        <div className="Title">
                            <h2>Poniendo todo junto <a target="_blank" rel="noreferrer" href="https://github.com/Felipe-Tello/Coding-Dojo-MERN/tree/main/2-%20ReactJS/2-%20Class%20components/2-%20Putting%20it%20together/client"><img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" width={50} height={50} alt="GitHub logo"/></a></h2>
                ...
                <Route path="/react-blocks" element={
                    <div>
                        <div className="Title">
                            <h2>Trazando nuestros bloques de React <a target="_blank" rel='noreferrer' href="https://github.com/Felipe-Tello/Coding-Dojo-MERN/tree/main/2-%20ReactJS/2-%20Class%20components/3-%20React%20blocks/client"><img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" width={50} height={50} alt="GitHub logo"/></a></h2>
