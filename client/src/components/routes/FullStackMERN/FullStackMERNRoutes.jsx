...
const FullStackMERNRoutes = () =>{
    ...
    const commonData1 = {
        title: 'Administrador de Producto (Parte I)',
    ...
    const commonData2 = {
        title: 'Administrador de Producto (Parte II)',
    ...
    const commonData3 = {
        title: 'Administrador de Producto (Parte III)',
    ...
    return(
        <div>
            <Routes>
                <Route path="/administrador-de-producto-parte-1" element={<Dashboard commonData1={commonData1} />}/>

                <Route path="/administrador-de-producto-parte-2" element={<Dashboard2 commonData2={commonData2}/>}/>
                <Route path="/administrador-de-producto-parte-2/:id" element={<ShowProduct2 commonData2={commonData2}/>} />

                <Route path="/administrador-de-producto-parte-3" element={<Dashboard3 commonData3={commonData3}/>}/>
                <Route path="/administrador-de-producto-parte-3/:id" element={<ShowProduct3 commonData3={commonData3}/>} />
                <Route path="/administrador-de-producto-parte-3/:id/edit" element={<UpdateProduct3 commonData3={commonData3}/>} />
            </Routes>
        </div>
    )
}
