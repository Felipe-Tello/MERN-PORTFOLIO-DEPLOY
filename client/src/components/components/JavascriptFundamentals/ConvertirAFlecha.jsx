...
const ConvertirAFlecha = () => {
    ...
    const handleHoverOut = () => {
        setBackgroundColorById("hover-this", "white");
    };
    ...
    const handleHoverOut2 = () => {
        setBackgroundColorById("bgcolor", "white");
    };

    return (
        <div>
            <div className="Title">
                <h2>Convertir a flecha <a target="_blank" href="https://github.com/Felipe-Tello/Coding-Dojo-MERN/blob/main/1-%20Javascript%20Fundamentals/1-%20Fundamentals/3-%20ConvertirAFlecha.html"><img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" width={50} height={50} alt="GitHub logo"/></a></h2>               
            ...
            <div className="Core no-code">
                <div style={{width:"80%", border:"2px black solid", borderRadius:"10px", padding:"5%"}}>
