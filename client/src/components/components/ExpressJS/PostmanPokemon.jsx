const PostmanPokemon = () => {
    return (
        <div>
            <div className="Title">
                <h2>Postman + Pokemon <a target="_blank" href="https://github.com/Felipe-Tello/Coding-Dojo-MERN/blob/main/3-%20ExpressJS/1-%20Express/1-%20Postman%20%2B%20Pokemon/PostmanPokemon.txt"><img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" width={50} height={50} alt="GitHub logo"/></a></h2>
