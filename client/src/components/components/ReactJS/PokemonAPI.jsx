...
const PokemonAPI = () => {
    ...
    return (
        <div>
            <div className="Title">
                <h2>API de Pokémon <a target="_blank" rel="noreferrer" href="https://github.com/Felipe-Tello/Coding-Dojo-MERN/tree/main/2-%20ReactJS/4-%20APIs/2-%20Pokemon%20Fetch/client"><img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" width={50} height={50} alt="GitHub logo"/></a></h2>
