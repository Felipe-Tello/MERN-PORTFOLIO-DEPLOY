...
const GeneradorDeCaja = () => {
    ...
    return (
        <div>
            <div className="Title">
                <h2>Generador de caja <a target="_blank" href="https://github.com/Felipe-Tello/Coding-Dojo-MERN/tree/main/2-%20ReactJS/3-%20Functional%20components/5-%20Box%20generator/client"><img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" width={50} height={50} alt="GitHub logo"/></a></h2>
            ...
            <div className="Core no-code">
                <div style={{minWidth:"40%", maxWidth:"50%", border:"2px solid black", borderRadius:"10px", padding:"5%"}}>
