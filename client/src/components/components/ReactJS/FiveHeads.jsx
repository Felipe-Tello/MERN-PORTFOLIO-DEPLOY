const FiveHeads = () => {
    return (
        <div>
            <div className="Title">
                <h2>Lanzamiento de monedas <a target="_blank" href="https://github.com/Felipe-Tello/Coding-Dojo-MERN/blob/main/2-%20ReactJS/4-%20APIs/1-%20Five%20Heads/FiveHeads.js"><img src="https://github.githubassets.com/images/modules/logos_page/GitHub-Mark.png" width={50} height={50} alt="GitHub logo"/></a></h2>
